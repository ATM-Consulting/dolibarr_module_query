...
print $form->selectarray('QUERY_GRAPH_PIEHOLE', array('0'=>'0%',  '0.1'=>'10%',  '0.3'=>'30%',  '0.5'=>'50%',  '0.7'=>'70%',  '0.9'=>'90%'), !empty($conf->global->QUERY_GRAPH_PIEHOLE) ? $conf->global->QUERY_GRAPH_PIEHOLE: ''  );
...
print $form->selectarray('QUERY_GRAPH_LINESTYLE', array('function'=>$langs->trans('Souple'), 'none'=>$langs->trans('Dur')), !empty($conf->global->QUERY_GRAPH_LINESTYLE) ? $conf->global->QUERY_GRAPH_LINESTYLE: ''  );
print '<input type="submit" class="button" value="'.$langs->trans("Modify").'">';
print '</form>';
print '</td></tr>';
...
print $form->selectyesno("QUERY_SHOW_PDF_TRANSFORM",!empty($conf->global->QUERY_SHOW_PDF_TRANSFORM) ? $conf->global->QUERY_SHOW_PDF_TRANSFORM: '',1);
print '<input type="submit" class="button" value="'.$langs->trans("Modify").'">';
print '</form>';
print '</td></tr>';
...
if(! empty($conf->global->QUERY_HOME_SELECTOR))
{
	...
	print $form->selectyesno("QUERY_DASHBOARD_OPEN_IN_NEW_TAB",!empty($conf->global->QUERY_DASHBOARD_OPEN_IN_NEW_TAB) ? $conf->global->QUERY_DASHBOARD_OPEN_IN_NEW_TAB: '',1);
	print '<input type="submit" class="button" value="'.$langs->trans("Modify").'">';
	print '</form>';
	print '</td></tr>';
}
...
print $form->selectyesno("QUERY_NO_DASHBOARD_ON_CARDS",!empty($conf->global->QUERY_NO_DASHBOARD_ON_CARDS) ? $conf->global->QUERY_NO_DASHBOARD_ON_CARDS: '',1);
print '<input type="submit" class="button" value="'.$langs->trans("Modify").'">';
print '</form>';
print '</td></tr>';
